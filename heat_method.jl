...
md"""Refine N: $(@bind n  PlutoUI.Slider(2:2:16,8,true))"""

# ╔═╡ 97460bf6-ce4f-4210-9664-8c6c43a9a382
let
	
# 	App() do
# 		slider = JSServe.Slider(LinRange(1,5,5))
# 		n = convert(Int, slider.value.val)
# 		println(n)
		fig = Figure()
...
# ╔═╡ 60b32931-89a5-4c38-a622-7f774ab084f3
...
manifest_format = "2.0"
project_hash = "5ca05630651b4cba337bd3a26a453dc7f01cb3e6"
...
[[deps.TupleTools]]
git-tree-sha1 = "dd0ee1e392438338abb678dacdcaef41724ec57a"
